...
theTime.add({
	...
	update: function(percent) {
		...
		document.querySelector('.container .sup').innerHTML= "I LOVE YOU " + (thePercent+2900);
	}
});
theTime.add({
	targets: getHeart,
...
document.querySelector('.Description .modal-title').innerHTML = '<i class="far fa-comment-alt"></i>&nbsp;Biết sao không ?';
document.querySelector('.Description .modal-body').innerHTML = 'Tại mày ngu =))<i class="fas fa-heart"></i> ';
